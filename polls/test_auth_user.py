...
class UserAuthTest(django.test.TestCase):
    ...
    def setUp(self):
        ...
        q = Question.objects.create(question_text="Test Poll Question")
        q.save()
        # a few choices
        for n in range(1,4):
    ...
    def test_logout(self):
        ...
        and then redirected to the default redirect page.
        """
    ...
    def test_login_view(self):
        ...
        # after login, should redirect us to the polls index page (or somewhere)
